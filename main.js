...
$(function() {
  ...
  function set_settings() {
    ...
    settings.defaultredirect = 'https://msu.co1.qualtrics.com/jfe/form/SV_5vWZ6TFHGDVNURU';
    ...
    // In condition 1, the participant will receive 2 like at the following timepoint (in ms). Default: [12000, 9999999]
    settings.condition_1_likes = [11000,15000,9999999]; 
    ...
    settings.likes_by = ['Gabe','Allyssa','Tyler','George','Josh','Lauren','Niki','Zoe','Lena']; 
  }
